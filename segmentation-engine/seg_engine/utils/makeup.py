...
if __name__ == '__main__':
    ...
    parsing_path = 'log/test_res/{}.png'.format(num)
    ...
    cv2.imwrite('log/makeup/116_ori.png', cv2.resize(ori, (512, 512)))
    cv2.imwrite('log/makeup/116_2.png', cv2.resize(image, (512, 512)))
