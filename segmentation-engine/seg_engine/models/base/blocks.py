...
__all__ = ['ConvBnAct', 'DepthwiseSeparableConv', 'InvertedResidual', 'CondConvResidual', 'EdgeResidual']
...
class ConvBnAct(nn.Module):
    ...
    def __init__(
            ...
            skip=False, act_layer=nn.ReLU, norm_layer=nn.BatchNorm2d, drop_path_rate=0., downsample=None, no_relu=False):
...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(
            ...
            se_layer=None, drop_path_rate=0., downsample=None, no_relu=False):
        super(DepthwiseSeparableConv, self).__init__()
        out_chs *= self.expansion
...
class InvertedResidual(nn.Module):
    ...
    def __init__(
            ...
            norm_layer=nn.BatchNorm2d, se_layer=None, conv_kwargs=None, drop_path_rate=0., downsample=None, no_relu=False):
...
class CondConvResidual(InvertedResidual):
    ...
    def __init__(
            self, in_chs, out_chs, dw_kernel_size=3, stride=1, dilation=1, pad_type='',
            noskip=False, exp_ratio=1.0, exp_kernel_size=1, pw_kernel_size=1, act_layer=nn.ReLU,
            norm_layer=nn.BatchNorm2d, se_layer=None, num_experts=0, drop_path_rate=0., downsample=None, no_relu=False):

        self.num_experts = in_chs
...
class EdgeResidual(nn.Module):
    ...
    def __init__(
            ...
            norm_layer=nn.BatchNorm2d, se_layer=None, drop_path_rate=0., downsample=None, no_relu=False):
