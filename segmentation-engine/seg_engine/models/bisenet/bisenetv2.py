...
class BiSeNetV2(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.output_aux:
            ...
            result.update(masks=(logits, logits_aux2, logits_aux3, logits_aux4, logits_aux5_4))
        result.update(pred=logits.argmax(dim=1))
        return result
    ...
    def get_params(self):
        ...
        for name, child in self.named_children():
            ...
            if isinstance(child, BGALayer) or isinstance(child, SegmentHead):
