...
default_cfgs = {
    ...
    'tf_mobilenetv3_large_minimal_100': _cfg(
        ...
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD),
    'tf_mobilenetv3_small_025': _cfg(
        url='/data/zhangziwei/.cache/torch/hub/checkpoints/mobilenetv3_small_025.pth',
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD),
    ...
    'tf_mobilenetv3_small_100': _cfg(
        ...
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD),
    'tf_mobilenetv3_small_minimal_025': _cfg(
        url='/data/zhangziwei/.cache/torch/hub/checkpoints/mobilenetv3_small_minimal_025.pth',
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD),
    'tf_mobilenetv3_small_minimal_050': _cfg(
        url='',
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD),
    'tf_mobilenetv3_small_minimal_075': _cfg(
        url='',
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD),
...
@META_ARCH_REGISTRY.register()
def tf_mobilenetv3_small_025(pretrained=False, **kwargs):
    """ MobileNet V3 """
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_small_025', 0.25, pretrained=pretrained, **kwargs)
    return model
...
@META_ARCH_REGISTRY.register()
def tf_mobilenetv3_small_minimal_025(pretrained=False, **kwargs):
    """ MobileNet V3 """
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_small_minimal_025', 0.25, pretrained=pretrained, **kwargs)
    return model


@META_ARCH_REGISTRY.register()
def tf_mobilenetv3_small_minimal_050(pretrained=False, **kwargs):
    """ MobileNet V3 """
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_small_minimal_050', 0.50, pretrained=pretrained, **kwargs)
    return model


@META_ARCH_REGISTRY.register()
def tf_mobilenetv3_small_minimal_075(pretrained=False, **kwargs):
    """ MobileNet V3 """
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_small_minimal_075', 0.75, pretrained=pretrained, **kwargs)
    return model
