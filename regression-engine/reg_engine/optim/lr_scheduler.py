...
class CyclicLR(lr_scheduler.CyclicLR):
    ...
    def from_config(cls, cfg, optim, step_per_epoch):
        return {
            'optimizer': optim,
            'base_lr': cfg.SOLVER.LR_SCHEDULER.LR_START,
            'max_lr': cfg.SOLVER.LR_SCHEDULER.MAX_LR,
        }
...
class ReduceLROnPlateau(lr_scheduler.ReduceLROnPlateau):
    ...
    def from_config(cls, cfg, optim, step_per_epoch):
        return {
            ...
            'verbose': cfg.SOLVER.LR_SCHEDULER.VERBOSE,
            'threshold': cfg.SOLVER.LR_SCHEDULER.THRESHOLD,
            'threshold_mode': cfg.SOLVER.LR_SCHEDULER.THRESHOLD_MODE,
            'cooldown': cfg.SOLVER.LR_SCHEDULER.COOLDOWN,
            'min_lr': cfg.SOLVER.LR_SCHEDULER.MIN_LR,
            'eps': cfg.SOLVER.LR_SCHEDULER.EPS
        }
...
class OneCycleLR(lr_scheduler.OneCycleLR):
    ...
    def from_config(cls, cfg, optim, step_per_epoch):
        return {
            'optimizer': optim,
            'max_lr': cfg.SOLVER.OPTIMIZER.LR_START,
