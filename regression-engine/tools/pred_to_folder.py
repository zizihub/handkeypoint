...
if __name__ == '__main__':
    csv_file = '/data2/zhangziwei/classification-engine/log/resnet18_MultiHead_sz360x240_kdl_0629-kd-b2-r18/r18_prob.csv'
    img_folder = '/data2/zhangziwei/datasets/ad-dataset/version7/others'
    pp = CSVProcess(csv_file=csv_file,
                    img_folder=img_folder)
    pp.prob_to_folder(output_folder='0629-kd-b2-r18')
